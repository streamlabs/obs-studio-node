...
template<typename BaseStreaming>
class EnhancedBroadcasting : public BaseStreaming {
public:
	...
	obs_video_info *GetAdditionalVideoCanvas() {
        return additionalVideoContext;
    }

    void SetAdditionalVideoCanvas(obs_video_info *video) {
        additionalVideoContext = video;
    }
